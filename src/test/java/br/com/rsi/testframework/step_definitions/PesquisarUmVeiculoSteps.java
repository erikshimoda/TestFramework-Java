...
import br.com.rsi.testframework.helpers.Log;
import br.com.rsi.testframework.modules.PreencherDadosFiltroVeiculo;
...
public class PesquisarUmVeiculoSteps {
	...
	public void eu_visualizo_uma_lista_de_modelos_de_veículos() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
